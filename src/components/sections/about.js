...
const About = () => {
  ...
  const skills = ['Python (pandas, numpy, plotly, sklearn, pytorch), SQL, YAML', 'Postgres, Clickhouse, MySQL, BigQuery', 'Docker','GIT','ORM, SOAP/REST Systems, Spark','AI-Model Chain Systems, Airflow, Tableau, Power BI, GCP'];
